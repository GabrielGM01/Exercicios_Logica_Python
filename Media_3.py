...
if(MP >= 7.0):
    print("Media: {:.1f}\nAluno aprovado.".format(MP))
elif(MP <5.0):
    print("Media: {:.1f}\nAluno reprovado.".format(MP))
else:
    print("Media: {:.1f}\nAluno em exame.".format(MP))
    exame = float(input("digite o exame final"))
    print("Nota do exame: {:.1f}".format(exame))
    NotaFinal = (exame + MP)/2
    if(NotaFinal >= 5.0):
        print("Aluno aprovado.\nMedia final: {:.1f}".format(NotaFinal))
    else:
